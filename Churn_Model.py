...
if __name__ == '__main__':
    ...
    print '\nThe churn prediction model has accuracy score of {}, precision score of {}, and recall score of {}.'.format(model.score(X2, y2), precision_score(y2, model.predict(X2)), recall_score(y2, model.predict(X2)))
